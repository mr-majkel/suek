...
Różnice w odsetkach uczniów uzyskujących poszczegolne kategorie pomiędzy wersjami testu są minimalne (wahają się w granicach 2-3 pkt. proc.). W związku z tym, można uznać, że wszystkie zadania kotwiczące dobrze spełniaja swoją funkcję.
