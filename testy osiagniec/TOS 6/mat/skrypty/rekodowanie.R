# Porady ogólne:
# 1. Jeżeli chcemy dowiedzieć się, jak działa jakaś funkcja możemy użyć funkcji
#   'help(nazwa_funkcji)' lub jej skrótu '?nazwa_funkcji'.
# 2. W nazwach zmiennych (obiektów) nie używamy polskich znaków.
# 3. Staramy się obkomentowywać skrypt w miarę postępów w analizach.
# 4. Staramy się trzymać limitu 80 znaków w linii.
