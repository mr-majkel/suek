...
``` {r, results = 'hide'}
mod0 = tam.mml.mfr(mat_all_r[, items1], formulaA = ~ item + item:step,
...
Ta ostatnia informacja jest szczególnie ważna w kontekście analizy oszacowań parametrów zadań. Informacje o parametrach zadań zawarte
