...
Dla większości zadań efekty związane z różnicami funkcjonowania pomiędzy wersjami są niewielkie. Tylko zadanie KMA\_24 i oszacowanie dla progów dla zadania KMA\_22 wykazują róźnicę w trudności pomiędzy wersjami większą od 0,2 logita (odpwoiednio, na korzyść wersji A i wersji B). Zadanie te są jednak dosyć trudne i duża różnica w logitach nie przekłada się bezpośrednio na prawdopodobieństwo odpowiedzi. Przyjrzyjmy się zatem tym ostatnim dla tych problematycznych zadań.
...
```{r, echo = FALSE}
cat("Zad. KMA_22\n")
round_df(print_ctt(ctt3, "KMA_22", "A"), 3)
round_df(print_ctt(ctt3, "KMA_22", "B"), 3)

cat("Zad. KMA_24\n")
round_df(print_ctt(ctt3, "KMA_24", "A"), 3)
round_df(print_ctt(ctt3, "KMA_24", "B"), 3)
